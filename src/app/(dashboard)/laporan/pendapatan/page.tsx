...
export default function LaporanPendapatanPage() {
  ...
  const handleExportToExcel = () => {
    ...
    link.setAttribute('download', `laporan_pendapatan_${timestamp}.csv`);
      ...
      <head>
        ...
        <style>
          ...
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .summary { background-color: #f0fdfa; padding: 15px; border-radius: 8px; margin-bottom: 20px; }
        ...
        <div class="summary">
          <div class="summary-grid">
            ...
            <div class="summary-item">
              ...
              <div class="value">${formatCurrency(totalPiutang)}</div>
            </div>
            <div class="summary-item">
              <div class="label">Total Invoice</div>
              <div class="value">${totalInvoice}</div>
            </div>
            <div class="summary-item">
              <div class="label">Invoice Lunas</div>
              <div class="value">${invoiceLunas}</div>
            </div>
          </div>
        </div>
        <table>
            ...
            ${invoiceList.map(item => {
              ...
              return `
                <tr>
                  ...
                  <td class="text-right">${formatCurrency(item.grandTotal)}</td>
                </tr>
              `;
            }).join('')}
