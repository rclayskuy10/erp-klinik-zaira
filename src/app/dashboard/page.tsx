      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4" suppressHydrationWarning>
            <button type="button" className="p-4 bg-teal-50 hover:bg-teal-100 rounded-lg transition-colors group" suppressHydrationWarning>
            ...
            <button type="button" className="p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors group" suppressHydrationWarning>
            ...
            <button type="button" className="p-4 bg-green-50 hover:bg-green-100 rounded-lg transition-colors group" suppressHydrationWarning>
            ...
            <button type="button" className="p-4 bg-orange-50 hover:bg-orange-100 rounded-lg transition-colors group" suppressHydrationWarning>
