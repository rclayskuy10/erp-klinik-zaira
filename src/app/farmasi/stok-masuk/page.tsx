...
export default function StokMasukPage() {
  ...
  const filteredRecords = dummyStokMasuk.filter(record => 
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold">{dummyStokMasuk.length}</p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold">
                {dummyStokMasuk.filter(s => s.status === 'selesai').length}
              </p>
        ...
        <Card className="p-4">
          <div className="text-center">
            <p className="text-xl font-bold text-teal-600">
              {formatCurrency(dummyStokMasuk.reduce((acc, s) => acc + s.total, 0))}
            </p>
